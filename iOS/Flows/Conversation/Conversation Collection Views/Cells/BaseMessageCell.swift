...
class BaseMessageCell: UICollectionViewCell {
    ...
    private(set) var attributes: ConversationCollectionViewLayoutAttributes?
    ...
    override func apply(_ layoutAttributes: UICollectionViewLayoutAttributes) {
        ...
        guard let attributes = layoutAttributes as? ConversationCollectionViewLayoutAttributes else { return }
    ...
    func layoutContent(with attributes: ConversationCollectionViewLayoutAttributes) {
