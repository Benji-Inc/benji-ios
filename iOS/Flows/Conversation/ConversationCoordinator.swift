...
class ConversationCoordinator: PresentableCoordinator<Void> {
    ...
    lazy var conversationVC = ConversationViewController(conversation: ConversationsManager.shared.topMostConversation)

    init(router: Router,
         deepLink: DeepLinkable?,
         conversation: Conversation?) {

        ConversationsManager.shared.topMostConversation = conversation
